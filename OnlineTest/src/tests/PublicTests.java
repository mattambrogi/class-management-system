...
public class PublicTests {
	...
	public void testMultipleChoiceKey() {
		...
		//System.out.println(answer);
		/*
		 * only printing last...are they in key?
		 */
//		for(Integer i : manager.allExamsTwo.get(10).getKey().keySet()) {
//			System.out.println(manager.allExamsTwo.get(10).getKey().get(i).getText());
//		}
